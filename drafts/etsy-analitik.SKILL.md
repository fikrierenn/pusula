...
Yüksek visit + Düşük conversion:
  ...
  Çözüm: Shipping >$6 ise fiyat yedir; review sayısı arttır
...
- **v1.0 (2026-05-17):** İlk sürüm. Universal Upgrade Framework + Etsy Stats funnel anatomisi + Search Visibility Dashboard (2026) + Marketplace Insights Tool (Eylül 2025) + 5 olası sebep listesi + eşik bantları + karşılaştırma disiplini + 10 pattern + ATLASCOREUS özelinde gözlemler. Skill adı `etsy-analitik` (Stats + Search Visibility + Marketplace Insights üçünü kapsayan şemsiye).
