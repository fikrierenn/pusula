...
/// <summary>Baskısı yok yapılan siparişler — gün bazlı özet (B-126). Kaynak JOKER.BASKISIYOK × J_ORDER_DETAILS.</summary>
public record BaskisiYokOzet(string Gun, int BarkodSayi, int SipSayi, int Miktar, decimal Tutar);
