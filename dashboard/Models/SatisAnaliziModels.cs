...
public sealed record SatisAnaliziSatir(
    ...
    string? Kat2,
    /// <summary>4. seviye (Kat3) — %8,7 dolu, 324 değer. Sınav hazırlıkta derinleşir.</summary>
    string? Kat3,
    /// <summary>5. seviye (Kat4) — %5,7 dolu, 597 değer. Ör. "…→ 8.Sınıf → Soru → Matematik".</summary>
    string? Kat4,
    string Yayinevi,
    string Yazar,
    decimal SatisFiyat,
...
public static class SatisAnaliziKolonlar
{
    ...
    [
        ...
        new("kategori1",  "Kategori1",  Varsayilan: false, Siralanabilir: true,
            Ipucu: "UrunBilgi.KatAna — ad yanıltıcı, alt kırılım VERMEZ. Yolun ilk basamağı."),
        new("katyol",     "Kategori Yolu", Varsayilan: true, Siralanabilir: true,
            Ipucu: "KatAna → Kat1 → Kat2 → Kat3 → Kat4 tek satırda, ör. \"Kırtasiye → Defterler → Çizgili Defter\". Boş basamak atlanır — ağaç dengesiz: kırtasiye 2, sınav hazırlık 5 basamak. Kategori3 AYRI sözlük, bu yola girmez."),
        new("kat1",       "Ürün Grubu", Varsayilan: false, Siralanabilir: true,
            Ipucu: "UrunBilgi.Kat1 — \"Defterler\", \"Kalemler ve Yazı Gereçleri\"… %90,9 dolu. Kategori1 (=KatAna) alt kırılım vermez, bu verir."),
        new("kat3",       "Alt Grup 3", Varsayilan: false, Siralanabilir: true,
            Ipucu: "UrunBilgi.Kat3 — %8,7 dolu."),
        new("kat4",       "Alt Grup 4", Varsayilan: false, Siralanabilir: true,
            Ipucu: "UrunBilgi.Kat4 — %5,7 dolu."),
