...
- [~] **B-91 WIP** ⚡ Blazor prerender double-render (commit pending). 5/12 sayfa tamamlandı: Home · Musteri · Eticaret · Operasyon · Sadakat. Kalan: Tahmin · Toplam · Magaza · Magazalar · Envanter (StreamRendering — dikkat) · Asistan · Gorevler. Her sayfa: PersistentComponentState TryTakeFromJson + RegisterOnPersisting + Dispose.
