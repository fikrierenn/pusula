...
- [x] **B-97** ✅ 17.06.2026 (commit pending) — LokasyonConfig.cs merkezi sabit (Subeler/SubelerVeDepo) + Queries.cs·RefQueries.cs·RefQueries.Envanter.cs 9 SQL noktası + olu_stok_excel.py + forecast/data.py güncellendi. UI toggle (5-lokasyon) → ayrı TODO.
