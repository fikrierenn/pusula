...
- [ ] **V-23 Dashboard Türkçe borcu: 2.431 bulgu dondurulmuş** (19.09, V-08'den doğdu) —
      çırcır artışı durduruyor ama borcu **azaltmıyor**. Kapı her koşumda "tabanın
      altında kalan dosya" listeliyor; o listeyi sıkıştırmak ilerlemenin tek yolu.
