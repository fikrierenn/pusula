...
- [~] **B-120 Kontrol paneli SP `SUM(bit)` fix** — ✅ **SOURCE DÜZELTİLDİ 24.06** (5 kolon `SUM(CAST(... AS int))`, `sorgular/2026-06-22-muhasebe-kontrol-v2.sql`). **KALAN: Fikri SP'yi yeniden deploy edecek** (ERP-write yasak, ben deploy edemem). Deploy sonrası panel çalışır.
