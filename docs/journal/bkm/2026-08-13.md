...
## Compact Snapshot --- 15:40

### Son 5 Commit

- 66e7fa0 docs(bkm): satınalma birim-maliyet metriği (sema) — fatura invoice-bazında SUM/SUM
- a4c04ad docs(bkm): oturum journalları — 29-30.06, 02.07, 13.08.2026
- c2cc85a docs(bkm): öneri sipariş backtest SQL arşivi (B-12/13 ikiz-yükümlülük)
- 171937d docs(bkm): JOKER SERVICEPRICE = vade farkı keşfi + SQL arşivi (B-12/13 ikiz)
- 85b0c22 feat(bkm): sayiyo excel raporu güncellemesi
