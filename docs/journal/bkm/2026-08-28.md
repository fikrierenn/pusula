# Oturum Günlüğü --- 2026-08-28


## Compact Snapshot --- 14:56

### Son 5 Commit

- 9c3d8d8 feat(bkm): müşteri grup parametresi — Rapor Parametreleri + hediye çeki paneli konsolidasyonu
- 9bfc428 fix(bkm): Esikler kaydı grup-içi tedarikçi listesini eziyordu (positional arg kayması)
- 28f076a feat(bkm): hediye çeki paneli — kanal + barem kârlılık + bonus simülatörü (plan-36)
- 11beec9 feat(bkm): hediye çeki indirim tavanı analizi + 2 veri kalitesi bulgusu
- 37544a6 fix(bkm): sema'dan satır verisi çıkarıldı — kural yazılır, liste yazılmaz
