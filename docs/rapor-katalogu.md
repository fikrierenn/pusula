...
| G2 | Ödeme tipi dağılımı (dün) | Nakit / Kredi / diğer % — kasa mutabakat | `sorgular/02-odeme/10_04_odeme-tipi-dagilimi.sql` (tarih → dün) | mevcut, tarih daralt |
| G3 | İade kontrolü (dün) | İade fiş adedi · iade tutarı · iade oranı % | `sorgular/05-iade/10_14_iade-analizi.sql` | mevcut |
| G4 | En çok satan 10 ürün / kategori (dün) | Top ürün + kategori payı | `sorgular/04-urun/10_21_en-cok-satan.sql` · `04-urun/10_12_kategori-bazli.sql` | mevcut |
